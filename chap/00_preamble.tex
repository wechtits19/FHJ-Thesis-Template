...
\usepackage{fontspec}
% Copperplate-ähnliche Schrift
\newfontfamily{\RegencyScriptFLFLarge}[Scale=1.7]{RegencyScriptFLF}
\newfontfamily{\RegencyScriptFLFNormal}[Scale=1.4]{RegencyScriptFLF}
\DeclareTextFontCommand \calli \RegencyScriptFLFLarge
\DeclareTextFontCommand \calliUpper \RegencyScriptFLFNormal
% language packages
